...
// KERNEL
// ========================================================
__constant__ float MASK[10];

__global__ void cudaConvolution_Shared_Memory_Symbol_Mask_3D_Float_Valid_X_Kernel(float* in, int dimx, int dimy, int dimz, int size2, float* out)
{
...
__global__ void cudaConvolution_Shared_Memory_Symbol_Mask_3D_Float_Valid_Y_Kernel(float* in, int dimx, int dimy, int dimz, int size2, float* out)
{
...
__global__ void cudaConvolution_Shared_Memory_Symbol_Mask_3D_Float_Valid_Z_Kernel(float* in, int dimx, int dimy, int dimz, int size2, float* out)
{
...
void cudaConvolution_Shared_Memory_Symbol_Mask_3D_Float_Valid_X(float* d_in, int dimx, int dimy, int dimz, float* mask, int maskSize, float* d_out)
{
	cudaMemcpyToSymbol(MASK, mask, maskSize * sizeof(float));
	dim3 block(10, 10, 10);
	dim3 grid((dimx - 1) / block.x + 1, (dimy - 1) / block.y + 1, (dimz - 1) / block.z + 1);
	cudaConvolution_Shared_Memory_Symbol_Mask_3D_Float_Valid_X_Kernel << <grid, block >> > (d_in, dimx, dimy, dimz, maskSize / 2, d_out);
